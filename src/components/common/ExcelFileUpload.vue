<template>
  <div>
    <!-- 上传文件组件 -->
    <el-upload ref="upload" :action="getActionUrl" :multiple="multiple" :limit="limit" :headers="myHeaders" accept=".xls,.xlsx"
      :on-exceed="handleExceed" :on-remove="handleRemove" :on-success="handleUploadSuccess" :on-error="handleUploadErr"
      :before-upload="handleBeforeUpload" :show-file-list="false" :on-change="handleChange">
      <el-button type="primary" icon="el-icon-upload">上传excel批量导入</el-button>
