<template>
  <div v-if="this.parent.gonggaoDetailFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" label-width="110px">
      ...
      <el-form-item class="dy-add-set-detail-el-form-item" label="图片:">
        <div v-if="ruleForm.tupian">
          <img :src="getFileSrc(ruleForm.tupian)" style="margin-right:20px;" width="300" height="200">
          <el-button class="el-icon-download" type="text" @click="download(ruleForm.tupian)">下载</el-button>
        </div>
        <div v-else>暂无图片</div>
      </el-form-item>
