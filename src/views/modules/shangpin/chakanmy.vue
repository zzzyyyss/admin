      ...
      <el-form :inline="true" :model="searchForm" class="dy-list-search-el-form">
        <el-row class="dy-list-search-el-form-row">
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.mingcheng" placeholder="名称" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
          ...
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-select v-model="searchForm.zhongleiid" placeholder="请选择分类">
          ...
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.danwei" placeholder="单位" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
