<template>
  <div v-if="this.parent.shoucangDetailFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="收藏时间:">
...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.shoucangSetFlag = false;
      this.parent.shoucangDetailFlag = false;
