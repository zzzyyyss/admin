<template>
  <div v-if="this.parent.usersPeisongAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="配送用户">
    ...
    <el-form-item class="dy-add-set-detail-el-form-item" label="是否接单" prop="songshenhe">
      <el-select v-model="ruleForm.songshenhe">
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersPeisongAddFlag = false;
      } else {
