<template>
  <div>
    <template v-if="this.parent.usersLiuyanChakanFlag && showFlag">
      <!--搜索表单区域-->
...
<script>
import LiuyanSet from "../liuyan/liuyan-set"
import LiuyanDetail from "../liuyan/liuyan-detail"
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersLiuyanChakanFlag = false;
      } else {
        this.$router.push('/');
      }
    },
