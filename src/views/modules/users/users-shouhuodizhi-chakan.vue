<template>
  <div>
    <template v-if="this.parent.usersShouhuodizhiChakanFlag && showFlag">
      <!--搜索表单区域-->
...
<script>
import ShouhuodizhiSet from "../shouhuodizhi/shouhuodizhi-set"
import ShouhuodizhiDetail from "../shouhuodizhi/shouhuodizhi-detail"
import ShouhuodizhiDingdanChakan from '../shouhuodizhi/shouhuodizhi-dingdan-chakan'
import ShouhuodizhiDingdanAdd from '../shouhuodizhi/shouhuodizhi-dingdan-add'
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersShouhuodizhiChakanFlag = false;
      } else {
        this.$router.push('/');
      }
    },
