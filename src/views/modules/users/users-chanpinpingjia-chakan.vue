<template>
  <div>
    <template v-if="this.parent.usersChanpinpingjiaChakanFlag && showFlag">
      <!--搜索表单区域-->
...
<script>
import ChanpinpingjiaSet from "../chanpinpingjia/chanpinpingjia-set"
import ChanpinpingjiaDetail from "../chanpinpingjia/chanpinpingjia-detail"
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersChanpinpingjiaChakanFlag = false;
      } else {
        this.$router.push('/');
      }
    },
