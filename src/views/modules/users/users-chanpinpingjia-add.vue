<template>
  <div v-if="this.parent.usersChanpinpingjiaAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="商品评价用户">
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersChanpinpingjiaAddFlag = false;
      } else {
