<template>
  <div>
    <template v-if="this.parent.usersShoucangChakanFlag && showFlag">
      <!--搜索表单区域-->
      ...
      @selection-change="selectionChangeHandler" :border="true">
        ...
        <el-table-column width="350" label="操作">
          <template slot-scope="scope">
            ...
            <el-button class="dy-list-detail-button" type="success" icon="el-icon-info" size="mini" @click="shoucangDetailHandler(scope.row.id)">详情</el-button>
            <!-- <el-button class="dy-list-update-button" type="primary" icon="el-icon-edit" size="mini" @click="shoucangSetHandler(scope.row.id)">修改</el-button> -->
            <!-- <el-button class="dy-list-delete-button" type="danger" icon="el-icon-delete" size="mini" @click="shoucangDeleteHandler(scope.row.id)">删除</el-button> -->
...
<script>
import ShoucangSet from "../shoucang/shoucang-set"
import ShoucangDetail from "../shoucang/shoucang-detail"
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.usersShoucangChakanFlag = false;
      } else {
        this.$router.push('/');
      }
    },
