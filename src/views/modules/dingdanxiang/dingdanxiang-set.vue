<template>
  <div v-if="this.parent.dingdanxiangSetFlag">
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.dingdanxiangSetFlag = false;
        this.parent.dingdanxiangDetailFlag = false;
      } else {
