<template>
  <div v-if="this.parent.shouhuodizhiDingdanAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="订单收货地址">
        <el-select v-model="shouhuodizhixingming" disabled>
        </el-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.shouhuodizhiid = id;
      }
      if (mingcheng) {
        this.shouhuodizhixingming = mingcheng;
      }
