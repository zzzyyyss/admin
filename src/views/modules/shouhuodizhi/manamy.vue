      ...
      @selection-change="selectionChangeHandler" :border="true">
        ...
        <el-table-column width="350" label="操作">
          <template slot-scope="scope">
              ...
              <el-button v-show="scope.row.shenhe == 'no'" class="dy-list-shehe-button" type="primary" icon="el-icon-edit-outline" size="mini" @click="shouhuodizhiSet(scope.row.id,'设为默认','shenhe','yes')">设为默认</el-button>
