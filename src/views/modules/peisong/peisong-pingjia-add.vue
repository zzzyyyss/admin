<template>
  <div v-if="this.parent.peisongPingjiaAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="评价配送">
        <el-select v-model="peisongxingming" disabled>
        </el-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.peisongid = id;
      }
      if (mingcheng) {
        this.peisongxingming = mingcheng;
      }
