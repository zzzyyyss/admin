    ...
    <template v-if="showFlag">
      ...
      <el-form :inline="true" :model="searchForm" class="dy-list-search-el-form">
        <el-row class="dy-list-search-el-form-row">
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.xingming" placeholder="客户姓名" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
          ...
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.dianhua" placeholder="电话" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
            <label class="dy-list-search-el-form-row-div-label">地址</label>
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.dizhi" placeholder="地址" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
            <label class="dy-list-search-el-form-row-div-label">是否接单</label>
            <el-select v-model="searchForm.songshenhe" placeholder="请选择是否接单">
              <el-option label="全部" value=""></el-option>
          ...
          <div class="dy-list-search-el-form-row-div">
            ...
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.psxingming" placeholder="配送员姓名" clearable></el-input>
          </div>
          <div class="dy-list-search-el-form-row-div">
            <label class="dy-list-search-el-form-row-div-label">配送员电话</label>
            <el-input style="width: auto;" suffix-icon="el-icon-search" v-model="searchForm.psdianhua" placeholder="配送员电话" clearable></el-input>
          </div>
      ...
      @selection-change="selectionChangeHandler" :border="true">
        ...
        <el-table-column width="350" label="操作">
          <template slot-scope="scope">
              <el-button class="dy-list-shehe-button" type="primary" icon="el-icon-edit-outline" size="mini" @click="peisongSet(scope.row.id,scope.row.songshenhe == 'no' ? '是否接单' : '已接单','songshenhe',scope.row.songshenhe == 'no' ? 'yes' : 'no')">{{scope.row.songshenhe == 'no' ? '是否接单' : '已接单' }}</el-button> 
  ...
  methods: {
    ...
    getDataList() {
      ...
      let params = {
        ...
        sortProperty: 'id',      //排序列
        usersslid: this.$storage.get('usersid'),
      }
      //搜索表单数据组装
