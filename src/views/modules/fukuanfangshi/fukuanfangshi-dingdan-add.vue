<template>
  <div v-if="this.parent.fukuanfangshiDingdanAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="订单付款方式">
        <el-select v-model="fukuanfangshimingcheng" disabled>
        </el-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.fukuanfangshiid = id;
      }
      if (mingcheng) {
        this.fukuanfangshimingcheng = mingcheng;
      }
