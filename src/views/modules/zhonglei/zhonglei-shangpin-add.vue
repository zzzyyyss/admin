<template>
  <div v-if="this.parent.zhongleiShangpinAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="商品分类">
        <el-select v-model="zhongleimingcheng" disabled>
        </el-select>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.zhongleiid = id;
      }
      if (mingcheng) {
        this.zhongleimingcheng = mingcheng;
      }
