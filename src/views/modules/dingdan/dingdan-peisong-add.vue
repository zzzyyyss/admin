<template>
  <div v-if="this.parent.dingdanPeisongAddFlag">
    <el-form class="dy-add-set-detail-el-form" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="110px">
      <el-form-item class="dy-add-set-detail-el-form-item" label="配送订单">
        <el-select v-model="dingdanbianhao" disabled>
        </el-select>
      </el-form-item>
    ...
    <el-form-item class="dy-add-set-detail-el-form-item" label="是否接单" prop="songshenhe">
      <el-select v-model="ruleForm.songshenhe" disabled>
    ...
    <el-form-item class="dy-add-set-detail-el-form-item" label="配送员" prop="usersslid">
      <el-select v-model="ruleForm.usersslid" placeholder="请选择配送员">
...
export default {
  ...
  methods: {
    ...
    init(id,mingcheng) {
      if (id) {
        this.ruleForm.dingdanid = id;
      }
      if (mingcheng) {
        this.dingdanbianhao = mingcheng;
      }
