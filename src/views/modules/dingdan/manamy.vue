        ...
        <el-table-column width="350" label="操作">
          <template slot-scope="scope">
            ...
            <el-button class="dy-list-delete-button" type="danger" icon="el-icon-delete" size="mini" @click="dingdanDeleteHandler(scope.row.id)">删除</el-button>
              ...
              <el-button class="dy-list-add-button" type="success" icon="el-icon-circle-plus" size="mini" @click="peisongAddHandler(scope.row.id, scope.row.bianhao)">配送安排2</el-button>
  ...
  methods: {
    ...
    getDataList() {
      ...
      let params = {
        ...
        sortProperty: 'id',      //排序列
        shangjia: this.$storage.get('usersid'),
      }
      //搜索表单数据组装
