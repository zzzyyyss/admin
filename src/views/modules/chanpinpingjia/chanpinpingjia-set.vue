<template>
  <div v-if="this.parent.chanpinpingjiaSetFlag">
  ...
  methods: {
    ...
    back() {
      if (this.parent) {
        ...
        this.parent.chanpinpingjiaSetFlag = false;
        this.parent.chanpinpingjiaDetailFlag = false;
      } else {
